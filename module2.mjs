...
export { c };       //Named export


/*
How to export variables from one file to another:
...
>> [Note: While importing "named" export you need to use the same variable name that you have used in module2.mjs]
>> For example: 
    let a = "Piyu";
    let b = "Rushi";
    export {a};
